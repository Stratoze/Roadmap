...
# Quote Package — {{date}} — {{title}}

What the shop needs to price you without emailing back. Send STEP + this sheet together.
...
- Tightest tolerance + where:
- Threads / reamed bores / critical fits:
