...
> Sources are selected JIT through the `resources` skill when a milestone activates. Historical candidates and verification decisions are in [[_system/learning/archive/source-ledger|source ledger]].
