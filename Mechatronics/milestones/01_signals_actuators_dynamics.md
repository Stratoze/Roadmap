...
- [ ] **Analog front end:** shunt resistor in series with motor, voltage across shunt amplified by current-sense amplifier (INA240, INA181, or discrete op-amp — INA219 is digital-out, not a sense amp), output visible on scope
- [ ] **Analog front end:** anti-aliasing RC filter before ADC input (e.g., 1kΩ + 1nF → ~160 kHz cutoff), verified on scope; captures filed per `_templates/mech/measurement_capture.md`
